function[SOLUZIONE,norm_v_inf_G] = TERRA_MARTE_GIOVE_URANO(d_Terra,d_Marte,d_Giove,d_Urano,gm_Terra,gm_Marte,gm_Giove,gm_Urano,gm_Sole,SOI_Terra,SOI_Marte,SOI_Giove,SOI_Urano,v_Terra,v_Marte,v_Giove,v_Urano,rp_Terra,rp_Urano,E_Terra_0,E_Marte_0,E_Giove_0,E_Urano_0,ET_t0,dV_Terra,dV,r_p_Marte,r_p_Giove,e_capture)
        ...
        for l=1:size(dV_tot,3)
            ...
            for k=1:size(dV_tot,4)
                for m=1:size(dV_tot,5)
                    ...
                    'delta_t',    delta_t,...        % [s] tempo di volo orbita iperbolica di approccioU
