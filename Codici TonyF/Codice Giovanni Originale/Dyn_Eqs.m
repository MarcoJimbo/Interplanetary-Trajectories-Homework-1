...
mu = 37931187; %[km^3/s^2] parametro gravitazionale saturno
global gamma_max W
% W = 0.0032;
...
dPr = (Ptheta*vtheta/r^2) + Pvr*((vtheta^2/r^2) + (2*mu/r^3)) -Pvtheta*(vr*vtheta/r^2);
dPtheta = 0;
