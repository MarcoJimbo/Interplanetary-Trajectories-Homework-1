...
R_start = 7*r_ur; %[km] %generalmente tra 1.000 km e 100.000 km sopra la superficie del pianeta, noi decidiamo di arrivare all'esterno della fascia F degli anelli di Saturno che hanno un raggio di 140180km dal centro di Saturno
...
theta0 = 0; 
vr0 = 0;
vtheta0 = sqrt(mu_ur/r0); 

% vincoli finali
rf = r_umbriel ; 
vrf = 0;
vthetaf = sqrt(mu_ur/rf); %thetaf è unparametro libero
...
Pvtheta0 = -2;
PC0 = -0.1;  %%questo è il moltiplicatore di lagrange associato all'eq.diff aggiuntiva dello stato
t_fin = 400000; %%tempo finale stimato con homann(a detta del professore)
%Cf = gamma_max * t_fin;
Cf = 0.1;
